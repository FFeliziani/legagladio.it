    ...
    public class Team
    {
        ...
        public static int calculateTeamValue(int id)
        {
            ...
            try
            {
                ...
                {
                    teamValue += Convert.ToInt32(p.Cost);
                }
