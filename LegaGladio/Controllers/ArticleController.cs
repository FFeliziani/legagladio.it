...
namespace LegaGladio.Controllers
{
    public class ArticleController : ApiController
    {
        ...
        [AcceptVerbs("GET", "POST")]
        [ActionName("getLast")]
        public ICollection<Article> GetLast(int id)
        {
        ...
        public ICollection<Article> GetByType(int id)
        {
        ...
        public ICollection<Article> GetLastByType(TypeCountData id)
        {
            return BusinessLogic.Article.ListArticleLastByType(id.Count, id.Type);
        }
