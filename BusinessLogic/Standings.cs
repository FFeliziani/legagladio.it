...
namespace BusinessLogic
{
    public static class Standings
    {
        ...
        public static IOrderedEnumerable<LegaGladio.Entities.Standing> GetStandings(LegaGladio.Entities.Series series)
        {
            try
            {
                var standings = new List<LegaGladio.Entities.Standing>();
        ...
        public static IOrderedEnumerable<LegaGladio.Entities.Standing> GetStandings(LegaGladio.Entities.Group group)
        {
            try
            {
                var standings = new List<LegaGladio.Entities.Standing>();
        ...
        private static IOrderedEnumerable<Standing> GetStandings(ICollection<LegaGladio.Entities.Game> games, List<Standing> standings)
        {
            foreach (var game in games)
            {
                if (game.GameDate != null | game.GameDate < DateTime.Now)
                {
                    var standingHome =
                        ...
                        new LegaGladio.Entities.Standing();
                    var standingGuest =
